...
async function showDirectoryProfile(profile){
 ...
 else body.append(el('p',key==='vs'?'Daily target: 7,200,000 · Six play days each week':key==='donations'?'Daily target: 5,000 · Seven days each week':'Approved event results linked to this player.'));
